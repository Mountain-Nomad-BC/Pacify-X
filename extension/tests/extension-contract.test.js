...
test('0.6.50 surfaces operational Studio setup, interactive graphs, JSON inspectors, telemetry, plugins, memory and activity observability, readiness, agent models, and the complete logo', () => {
  const surfaceStyles = fs.readFileSync(path.join(root, 'media', 'styles', '40-surfaces.css'), 'utf8');
  assert.equal(pkg.version, '0.6.50');
