...
from runtime.declared_suite import (  # noqa: E402 -- local source bootstrap
    list_outcomes,
    plan_outcome,
    run_script_outcome,
    ...
    with tempfile.TemporaryDirectory() as temporary:
        ...
        script_input = {
            **positive,
            ...
            "candidate": 12,
            "candidates": [
                {"id": "a", "metrics": {"quality": 1.0}},
                {"id": "b", "metrics": {"quality": 0.5}},
            ],
            "weights": {"quality": 1.0},
        ...
        for record in list_outcomes(root)["records"]:
            ...
            evidence = {
                "positive_plan_sha256": sha256_json(planned),
                "negative_case_sha256": sha256_json(denied),
            }
...
def main() -> int:
    ...
    if args.apply:
        ...
        ledger["status"] = (
            "complete" if summary["open_cards"] == 0 else "active_reconstruction"
        )
