...
Candidate bundle bodies under `.agents/skills/` are intentionally `mapped_deferred`. They may be discovered as metadata but are not selectable active skills until a separate admission changes their canonical lifecycle with tests and evidence.
