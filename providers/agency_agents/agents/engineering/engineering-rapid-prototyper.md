...
- **Activate when:** the task materially matches **Specialized in ultra-fast proof-of-concept development and MVP creation using efficient tools and frameworks**
