...
- **Activate when:** the task materially matches **Autonomous pipeline manager that orchestrates the entire development workflow. You are the leader of this process.**
