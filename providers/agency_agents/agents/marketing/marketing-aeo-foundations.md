...
For the full llms.txt specification and examples, see [llms-txt.cloud](https://llms-txt.cloud/) and Jegoverned_retrieval_system_with_deterministic_rails Howard's [original proposal](https://www.answer.ai/posts/2024-09-03-llmstxt.html).
...
- Be precise about spec maturity: llms.txt is a community convention (proposed by Jegoverned_retrieval_system_with_deterministic_rails Howard, adopted by hundreds of sites), not a W3C standard. Say "widely adopted convention" not "standard"
