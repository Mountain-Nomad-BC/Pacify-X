...
def main() -> int:
    ...
    print(json.dumps({key: result[key] for key in ("valid", "python_file_count", "syntax_valid_count", "packaged_file_count", "direct_behavior_count", "evidence_association_count", "source_only_structural_count", "errors")}, indent=2))
