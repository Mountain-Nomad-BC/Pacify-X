...
def record(
    ...
    **extra: object,
    ...
    producers = {
        ...
        "registry/authority_topology.json": "runtime/authority_topology.py",
        "registry/capability_maturity_policy.json": "runtime/capability_maturity.py",
        ...
        "registry/dependency_authority.json": "runtime/dependency_invalidation.py",
        "registry/effect_surface_ownership.json": "scripts/build_effect_surface_ownership.py",
        "registry/evidence_type_policy.json": "runtime/evidence_claims.py",
        ...
        "registry/primitive_authority.json": "runtime/primitive_authority.py",
        "registry/px_world_state.json": "runtime/world_state.py",
...
def build_inventory() -> dict[str, object]:
    rows = [
        ...
        record("registry/authority_topology.json", "effect_count", "effects"),
        record("registry/capability_maturity_policy.json", "level_count", "levels"),
        ...
        record("registry/dependency_authority.json", "node_kind_count", "node_kinds"),
        record(
        ...
        record("registry/evidence_type_policy.json", "evidence_type_count", "evidence_types"),
        record(
        ...
        record("registry/primitive_authority.json", "primitive_count", "primitives"),
        record(
        ...
        record(
            ...
            "details",
            "external_length",
            source_path="registry/agency_agent_registry.json",
            source_key="agents",
        ),
        record(
            "registry/px_world_state.json",
            ...
            "details",
            "external_length",
            source_path="registry/authority_topology.json",
            source_key="effects",
        ),
        record(
            "registry/px_world_state.json",
            ...
            "details",
            "external_length",
            source_path="registry/semantic_capability_index.json",
            source_key="records",
        ),
        record(
            "registry/px_world_state.json",
            ...
            "details",
            "external_scalar",
            source_path="registry/operational_gap_ledger.head.json",
            source_key="event_count",
            source_default=0,
        ),
        record(
            "registry/px_world_state.json",
            ...
            "details",
            "external_length",
            source_path="registry/models.json",
            source_key="models",
        ),
        record(
            "registry/px_world_state.json",
            ...
            "external_scalar",
            source_path="registry/operational_gap_ledger.head.json",
            source_key="dashboard.critical_high_blocker_count",
            source_default=0,
        ),
        record(
            "registry/px_world_state.json",
            ...
            "details",
            "external_filtered",
            source_path="registry/projection_staleness.json",
