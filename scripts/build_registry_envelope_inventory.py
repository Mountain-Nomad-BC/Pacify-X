...
def record(path: str, count_key: str, collection_key: str, rule: str = "length", **extra: object) -> dict[str, object]:
    producers = {
...
def build_inventory() -> dict[str, object]:
    rows = [
        ...
        record("registry/corrective_release_ledger.json", "child_finding_count", "cards", "child_cards"),
        record("registry/corrective_release_ledger.json", "source_card_count", "cards", "source_cards"),
        record("registry/effect_surface_ownership.json", "record_count", "records"),
        record("registry/declared_capability_recovery_map.json", "record_count", "records"),
        ...
        record("registry/graphs/project_stream_dependency_graph.json", "capability_reference_count", "edges"),
        record("registry/graphs/project_stream_dependency_graph.json", "node_count", "nodes"),
        record("registry/graphs/project_stream_dependency_graph.json", "orchestration_count", "edges", "unique", field="source"),
        record("registry/historical_external_references.json", "reference_count", "records"),
        ...
        record("registry/project_stream_handlers.json", "executable_count", "workflows", "filtered", field="status", equals="executable"),
        record("registry/project_stream_handlers.json", "plan_only_count", "workflows", "filtered", field="status", equals="plan_only"),
        record("registry/project_stream_orchestrations.json", "count", "orchestrations"),
        record("registry/python_surface_ownership.json", "direct_behavior_count", "records", "filtered", field="validation_level", equals="direct-isolated-behavior"),
        record("registry/python_surface_ownership.json", "direct_test_reference_count", "records", "filtered", field="validation_level", equals="direct-test-reference"),
        record("registry/python_surface_ownership.json", "packaged_file_count", "records", "filtered", field="packaged", equals=True),
        record("registry/python_surface_ownership.json", "python_file_count", "records"),
        record("registry/python_surface_ownership.json", "source_only_structural_count", "records", "filtered", field="validation_level", equals="source-only-structural"),
        record("registry/python_surface_ownership.json", "syntax_valid_count", "records", "filtered", field="syntax_valid", equals=True),
        record("registry/reference_candidate_admission.json", "canonical_candidate_count", "records", "unique", field="canonical_id"),
        record("registry/reference_candidate_admission.json", "duplicate_source_record_count", "records", "duplicates", field="canonical_id"),
        record("registry/reference_candidate_admission.json", "source_record_count", "records"),
        ...
        record("registry/source_specialty_admission.json", "source_record_count", "records"),
        record("registry/specialty_map.json", "active_candidate_count", "categories", "nested_filtered", nested="specialties", field="state", equals="active"),
        record("registry/specialty_map.json", "candidate_count", "categories", "nested_length", nested="specialties"),
        record("registry/specialty_map.json", "deferred_candidate_count", "categories", "nested_filtered", nested="specialties", field="state", equals="mapped_deferred"),
        record("registry/workflow_execution_bindings.json", "count", "bindings"),
    ]
    return {"schema_version": "1.0", "policy": "Every count-bearing registry field is derived from its owned collection and validated before certification.", "records": rows}
...
def main() -> int:
    ...
    print(json.dumps({"valid": True, "records": len(build_inventory()["records"]), "check": args.check}))
    return 0
