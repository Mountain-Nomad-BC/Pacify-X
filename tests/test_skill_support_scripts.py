...
class SkillSupportScriptTests(unittest.TestCase):
                ...
                json.dumps(
                    {
                        "files": [
                            {
                                "path": "packs/01/skills/a/skill.json",
                                "bytes": 2,
                                "sha256": "a" * 64,
                            }
                        ]
    ...
    def test_planning_card_coverage_validator_checks_real_owners_and_tests(
        self,
    ) -> None:
        module = load_script(
    ...
    def test_bootstrap_audit_reporter_renders_failures_without_hiding_them(
        self,
    ) -> None:
        module = load_script(
