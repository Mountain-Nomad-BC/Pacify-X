...
For v0.7.0, the local custody handoff is prepared only after the final103 certificate exists:
...
$summary = "evidence/release/final103-installed-operational-summary.json"
...
python -B scripts/package_release_evidence.py `
  ...
  --candidate-id "pacify-x-certification-20260906-final103-single" `
  --vsix $vsix `
